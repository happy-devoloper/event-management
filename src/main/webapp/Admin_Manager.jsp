        ...
        <div id="main-wrapper">
            ...
            ***********************************-->
            <div class="nav-header">
                <a href="AdminManagerPageController" class="brand-logo">
                                    ...
                                    <form action="MainController" method="POST">
                                        <div class="input-group search-area d-xl-inline-flex d-none">
                                            ...
                                            <div class="input-group-append">
                                                <button class="input-group-text" name="action" value="SearchManager"><i class="flaticon-381-search-2"></i></button>
                                            </div>
                                        </div>
                                    </form>
